...
public interface ScoreMapper extends BaseMapper<Score> {
    ...
    IPage<ProgramListForScore> getProList(Page<ProgramListForScore> page, @Param("code") String code, @Param("comId") Integer comId);

    Integer upload(@Param("jCode") String JudgeCode, @Param("uCode") String userCode, @Param("comId") Integer comId, @Param("score") Integer score, @Param("opinion") String opinion);
    ...
    Integer updateScore(@Param("comId") Integer comId, @Param("teacher") String teacher, @Param("student") String student, @Param("score") Integer score, @Param("opinion") String opinion);
